<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockIn.aspx.cs" Inherits="system_StockIn" %>
    ...
    <div>
        ...
        <table id="wsd_inputtable">
            ...
            <tr>
                ...
                <td>
                    <input class="wsd_input" id="txtOrder" type="text" runat="server" /><asp:RequiredFieldValidator
                        ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtOrder" ErrorMessage="请填写入库单号!">*</asp:RequiredFieldValidator>
                </td>
                <td class="tablefield">
                    &nbsp;产品条码
                </td>
                <td class="style1">
                    <input class="wsd_input" id="txtProduct" type="text" runat="server" />
                </td>
            </tr>
            <tr>
