...
//3.eclipse中显示错误的语句；
//
//by | ferrygao | csdn | 2007年8月24日 星期五
document.write("<div id=meizzCalendarLayer style='position: absolute; z-index: 9999; width: 144; height: 193px; display: none'>");
...
function writeIframe()
{
    ...
    "    <table id=tableDay height=120 width=140 border=0 cellspacing=1 cellpadding=0>";
         ...
         strIframe +="<td align=center bgcolor="+WebCalendar.btnBgColor+" colspan=3 class=out title='"+ WebCalendar.regInfo +"'>"+
	 "<input style=' background-color: "+
         WebCalendar.btnBgColor +";cursor: hand; padding-top: 4px; height: 100%; border: 0' onfocus='this.blur()'"+
         " type=button value='清空' onclick=\"parent.valueClean()\">"+
	 " "+
