...
namespace PsionTeklogixRFIDDemoApplications
{
	...
	/// </summary>
	public class HID_ReaderMiFareStandard : System.Windows.Forms.Form
	{
        ...
        public HID_ReaderMiFareStandard(HID_Reader reader)
        {
            //
		...
		private void InitializeComponent()
		{
            ...
            this.Name = "HID_ReaderMiFareStandard";
            this.Text = "Reader MiFare Standard";
		...
		private void _btWrite_Click(object sender, System.EventArgs e)
		{
			...
			// Login
            Reader.RDR_SendCommandGetData("L01AAFFFFFFFFFFFF", "", ref Buffer);
			if ( Buffer.Substring(0, 1) != "L" )
			{
				this.listBox1.Items.Add ("Login error");
				return;
			}
